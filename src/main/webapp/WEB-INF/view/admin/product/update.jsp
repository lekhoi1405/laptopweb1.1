              ...
              <div class="row justify-content-center">
                <div class="col-12 col-md-6">
                  ...
                  >
                    ...
                    <div class="col-12">
                      <img style="max-height: 250px; display: block;" src="/images/product/${product.image}" alt="image preview"
                      id="imagePreview">
                    </div>
                    
                    <div class="col-12 d-flex justify-content-between">
                      <a href="/admin/product" class="btn btn-success col-2">Back</a>
                      <button type="submit" class="btn btn-danger col-2">Update</button>
                    </div>
                  </form:form>
                </div>
              </div>
